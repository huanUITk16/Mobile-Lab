...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        handleClickAnimationXml (btnSlideUpXml, R. anim.anim_silde_up);
    ...
    private Animation initMoveOutAnimation()
    {
        Animation animation = new TranslateAnimation(
                Animation.RELATIVE_TO_SELF, 1.0f,
                Animation.RELATIVE_TO_SELF, 0.0f,
    ...
    {
        ScaleAnimation animationScale = new ScaleAnimation(1, 3, 1, 3, 50, 50);
        animationScale.setDuration(4000);
        animationScale.setAnimationListener(animationListener);
        RotateAnimation animationRotate  =  new RotateAnimation(0,360,50,50);
        animationRotate.setDuration(500);
        animationRotate.setRepeatCount(2);
        animationRotate.setRepeatMode(RESTART);
    ...
    private Animation initRotateAnimation()
    {
        ...
        rotateAnimation.setInterpolator(getApplicationContext(), android.R.anim.cycle_interpolator);
